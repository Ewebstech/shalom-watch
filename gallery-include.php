<!-- Caption Style -->
    ...
    <div id="slider1_container" style="position: relative; width: 800px; height: 400px; overflow: hidden; border: 6px inset rgba(204,0,102,1); border-radius: 10px;" class="center">
